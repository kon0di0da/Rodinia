...
void BFSGraph( int argc, char** argv) 
{
	...
	Node* h_graph_nodes;
	cudaHostAlloc((void **) &h_graph_nodes,sizeof(Node)*no_of_nodes,cudaHostAllocDefault);
	bool *h_graph_mask;
	cudaHostAlloc((void **) &h_graph_mask,sizeof(bool)*no_of_nodes,cudaHostAllocDefault);
	bool *h_updating_graph_mask;
	cudaHostAlloc((void **) &h_updating_graph_mask,sizeof(bool)*no_of_nodes,cudaHostAllocDefault);
	bool *h_graph_visited;
	cudaHostAlloc((void **) &h_graph_visited,sizeof(bool)*no_of_nodes,cudaHostAllocDefault);
